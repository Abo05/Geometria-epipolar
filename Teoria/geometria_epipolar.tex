...
\begin{enumerate}
    ...
    \begin{figure}[H]
        ...
        \label{fig:ransac}
    \end{figure}
    \item Finalmente, con el conjunto completo de aciertos identificado por  RANSAC, se re-estima F usando mínimos cuadrados. Al utilizar muchos más puntos que los 7 iniciales, y al estar todos ellos libres de errores, la solución final es significativamente más precisa y estable que cualquiera de las estimadas durante el bucle.
\end{enumerate}
