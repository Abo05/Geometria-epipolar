...
Para que este cálculo sea eficiente, es necesario entender la geometría que
relaciona las dos cámaras entre sí y con la escena. Esa geometría es la
\textit{geometría epipolar}, que impone restricciones precisas sobre dónde
puede aparecer el correspondiente de un punto en la segunda imagen, reduciendo
la búsqueda de un problema bidimensional a uno unidimensional.
...
El desarrollo teórico expuesto en las secciones anteriores se ha materializado en un programa en Python capaz de generar un mapa de profundidad a partir de un par estéreo. Para ello, se ha implementado la estimación de la matriz fundamental $F$ mediante el algoritmo de los 8 puntos normalizado, integrado dentro de un bucle probabilístico RANSAC para descartar los \textit{outliers}.
